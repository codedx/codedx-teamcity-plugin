 ...
 * be accepted by the decision of an {@link FingerprintStrategy} that is
 * passed as a constructor argument. Certificates added in this way will be
 * added via a {@link SingleCertManager}, causing the underlying trust manager to
 * be reloaded.
 *
...
public class ReloadableX509TrustManager implements X509TrustManager {
	...
	/* package-private */final SingleCertManager certManager;
	private final FingerprintStrategy invalidCertStrat;
	private X509TrustManager tmDelegate;

	public ReloadableX509TrustManager(SingleCertManager certManager, FingerprintStrategy invalidCertStrat) throws
